...
import com.sometimestwo.jumble.VideoCacher.HttpProxyCacheServer;
...
public final class App extends Application {
    ...
    private static JumbleInfoObj currSubredditObj;
    ...
    // the JumbleInfoObj subreddit stack to track which paginator to use.
    ...
    public void onCreate() {
        ...
        currSubredditObj = new JumbleInfoObj();
    ...
    public static JumbleInfoObj getJumbleInfoObj() {return currSubredditObj;}
