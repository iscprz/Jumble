...
import com.sometimestwo.jumble.Model.CommentObj;
import com.sometimestwo.jumble.Model.ExpandableCommentGroup;
...
import com.sometimestwo.jumble.Utils.DownloadBinder;
import com.sometimestwo.jumble.Utils.DownloadService;
...
public class FragmentFullDisplay extends Fragment implements OnVRedditTaskCompletedListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mediaDataSourceFactory = new DefaultDataSourceFactory(getContext(),
                Util.getUserAgent(getContext(), "Jumble"),
                    ...
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        switch (menuItem.getItemId()) {
                            case R.id.menu_full_display_overflow_goto_subreddit:
                                App.getJumbleInfoObj().getmSubredditStack().push(mCurrSubmission.getSubreddit());
